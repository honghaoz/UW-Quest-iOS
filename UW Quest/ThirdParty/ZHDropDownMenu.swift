...
extension UIView {
    ...
    // MARK: Add blur view
    func addBackupBlurView(#tag: Int, animated: Bool = false, completion: ((Bool) -> Void)? = nil) {
        if self.superview == nil {
            return
        }
        var blurView: UIView!
    ...
    func removeBackBlurView(#tag: Int, animated: Bool = false, completion: ((Bool) -> Void)? = nil) {
        if self.superview == nil {
            return
        }
